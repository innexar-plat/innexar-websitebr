...
const statusIcons = {
    requested: { icon: Clock, color: 'blue', step: 0 },
...
function DashboardContent() {
    ...
    const getStatusLabel = (status: string) => {
        const labels: Record<string, { label: string; description: string }> = {
            requested: { label: t('status.requested'), description: t('welcome.subtitle') },
                    ...
                    >
                        <div className="flex flex-col md:flex-row items-center gap-6">
                            ...
                            {order.status === 'onboarding_pending' && (
                                <a
                                    href={
                                        order.service_type === 'application'
                                            ? `/launch/onboarding/app?order_id=${order.id}`
                                            : `/launch/onboarding?order_id=${order.id}`
                                    }
