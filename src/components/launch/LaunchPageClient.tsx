...
export default function LaunchPageClient() {
    ...
    const whatsappNumber = config.site_whatsapp_br || config.site_phone_br?.replace(/\D/g, '') || WHATSAPP_FALLBACK_NUMBER
    ...
    const handleCheckout = async () => {
        ...
        const message = `Olá! Quero aproveitar a oferta do site profissional por R$ 1.997.\n\nAdicionais selecionados:\n${selectedAddons.join('\n')}`;
